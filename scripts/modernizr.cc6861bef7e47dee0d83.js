...
!*/
p.addTest("webworkers","Worker"in e),o(),T(f),delete C.addTest,delete C.addAsyncTest;for(var W=0;W<p._q.length;W++)p._q[W]();e.Modernizr=p}(t,document),e.exports=t.Modernizr}(window)},59:function(e,t){var i;i=function(){return this}();try{i=i||Function("return this")()||(0,eval)("this")}catch(n){"object"==typeof window&&(i=window)}e.exports=i},625:function(e,t,i){/*!mobile-detect v1.3.3 2016-07-31*/
